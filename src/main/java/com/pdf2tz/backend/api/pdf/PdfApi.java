...
public interface PdfApi {
     ...
     *
     * <p>Ответ содержит страницы с очищенным текстом и структурированными таблицами.
     * Сначала возвращается текст страницы, затем начинающиеся на ней таблицы сверху вниз;
     * точное чередование абзацев и таблиц пока не восстанавливается. Ручка предназначена для проверки итоговой
